...
//A Web Filter is like a checkpoint or gatekeeper that sits before your request reaches the backend and after the response comes back.
//Simple Idea-:
//Think of it like security at a mall entrance:
//You enter → security checks you 🔍
//Then you go inside 🏬
//When you leave → they might check again

//Here we learn how to decode token and retrieve useful information.
//we make object of that information and save in datbases.